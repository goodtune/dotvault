...
function RuleCard({ rule }) {
  ...
  return h('div', { class: 'config-card' },
    h('div', { class: 'config-card-title' },
      ...
      target?.delete_nulls && h('span', { class: 'config-tag config-tag-warn' }, 'deletes nulls'),
    ...
    h(KeyValueTable, {
      rows: [
        ...
        target?.delete_nulls ? ['Delete nulls', 'yes — a null in the template removes the key'] : null,
