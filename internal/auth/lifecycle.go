...
// freshly-written token file (the configured tokenFilePath, by default
// ~/.dotvault-token) is picked up without waiting for the 5-minute
// lifecycle tick. Coalescing: concurrent or back-to-back
